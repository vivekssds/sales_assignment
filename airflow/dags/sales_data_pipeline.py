...
def sales_data_pipeline():     
    ...
    def build_exec_pipeline_sales_data(sales_data_df, users_data_df):
        ...
        users_sales_data_df['sunrise_time'] = pd.to_datetime(users_sales_data_df['sunrise'], unit='s').dt.time
        users_sales_data_df['sunset_time'] = pd.to_datetime(users_sales_data_df['sunset'], unit='s').dt.time
        ...
        users_sales_data_df.to_sql('sales_raw_data_tbl', con=engine, schema='sales_raw', if_exists='append', index=False)
